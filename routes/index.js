...
const routeRegistry = [
  ...
  { path: '/api/v1/auth/2fa', routes: twoFactorRoutes },
  ...
  { path: '/api/v1/notifications', routes: require('./notifications') },
